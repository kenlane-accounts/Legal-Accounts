...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { casestatus_id: @case.casestatus_id, client_id: @case.client_id, description: @case.description, reference: @case.reference }
    end
  ...
  test "should update case" do
    patch :update, id: @case, case: { casestatus_id: @case.casestatus_id, client_id: @case.client_id, description: @case.description, reference: @case.reference }
    assert_redirected_to case_path(assigns(:case))
  end
