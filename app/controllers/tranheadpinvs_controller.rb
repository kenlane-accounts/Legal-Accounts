class TranheadpinvsController < ApplicationController
  before_action :set_tranhead, only: [:show, :edit, :update, :destroy]

  # GET /tranheads
  # GET /tranheads.json
  def index
    @tranhead = Tranheads::Pinv.all
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tranheadpinvs_url, notice: 'Tranhead was successfully destroyed.' }
